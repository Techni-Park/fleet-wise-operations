...
interface VehicleCustomFieldsFormProps {
  vehicleId?: number; // IDMACHINE pour l'édition
  values: { [key: string]: string };
  onChange: (fieldId: number, value: string) => void;
}

const VehicleCustomFieldsForm: React.FC<VehicleCustomFieldsFormProps> = ({ 
  vehicleId, 
  values, 
  onChange 
}) => {
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-500 text-center py-4">
            Aucun champ personnalisé configuré pour les véhicules.
          </p>
        </CardContent>
      </Card>
    );
...
export default VehicleCustomFieldsForm; 