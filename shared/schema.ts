...
export const paramappli = mysqlTable("PARAMAPPLI", {
  IDPARAMAPPLI: int("IDPARAMAPPLI").primaryKey().autoincrement(),
  RAISON_SOCIALE: varchar("RAISON_SOCIALE", { length: 160 }),
  US_RESP: varchar("US_RESP", { length: 3 }),
  TYP_UTILISATION: smallint("TYP_UTILISATION"),
  ADRESSE: varchar("ADRESSE", { length: 80 }),
  CDREGION: varchar("CDREGION", { length: 3 }),
  CPOSTAL: varchar("CPOSTAL", { length: 9 }),
  VILLE: varchar("VILLE", { length: 30 }),
  CDPAYS: varchar("CDPAYS", { length: 3 }),
  WEBSITE: varchar("WEBSITE", { length: 60 }),
  EMAIL: varchar("EMAIL", { length: 64 }),
  SIRET: varchar("SIRET", { length: 21 }),
  TEL1: varchar("TEL1", { length: 18 }),
  TYPTEL1: tinyint("TYPTEL1"),
  TEL2: varchar("TEL2", { length: 18 }),
  TYPTEL2: tinyint("TYPTEL2"),
  TEL3: varchar("TEL3", { length: 18 }),
  TYPTEL3: tinyint("TYPTEL3"),
  STATUT_SOCIAL: varchar("STATUT_SOCIAL", { length: 50 }),
  NUM_TVA: varchar("NUM_TVA", { length: 20 }),
  RCS: varchar("RCS", { length: 30 }),
  DT_IMMAT: date("DT_IMMAT"),
  CODE_APE: varchar("CODE_APE", { length: 5 }),
  COMPTE_BQ_PRINC: varchar("COMPTE_BQ_PRINC", { length: 50 }),
  INONASS_TVA: tinyint("INONASS_TVA"),
  MTT_CAPITAL: int("MTT_CAPITAL"),
  IAUTOENTREP: tinyint("IAUTOENTREP"),
  LIB_NONASS: varchar("LIB_NONASS", { length: 50 }),
  MODE_TVA: smallint("MODE_TVA"),
  ITAX_CANADA: tinyint("ITAX_CANADA"),
  TXTAX_CANADA: float("TXTAX_CANADA"),
  DT_PREMEXERCICE: date("DT_PREMEXERCICE"),
  TX_FRAIS_GENERAUX: float("TX_FRAIS_GENERAUX"),
  PRIVIL_PGMEXTERNE: smallint("PRIVIL_PGMEXTERNE"),
  PRIVIL_EXPORT: tinyint("PRIVIL_EXPORT"),
  AFF_ONGLET_CONTACT: tinyint("AFF_ONGLET_CONTACT"),
  TYPDONNEES_CONTACT: smallint("TYPDONNEES_CONTACT"),
  IGERE_ADRCOMP: tinyint("IGERE_ADRCOMP"),
  COUL_CONTACT: int("COUL_CONTACT"),
  IGERE_DONNCOMM: tinyint("IGERE_DONNCOMM"),
  IGERE_DCOMPLENF: tinyint("IGERE_DCOMPLENF"),
  AFF_ONGLET_PROJET: tinyint("AFF_ONGLET_PROJET"),
  IGERE_PROJ_SUIVINOM: tinyint("IGERE_PROJ_SUIVINOM"),
  LOGO_L: longtext("LOGO_L"),
  MODEAFF_LOGO: smallint("MODEAFF_LOGO"),
  LOGO_R: longtext("LOGO_R"),
  LOGO_D: longtext("LOGO_D"),
  TYLOGO_COURRIER: smallint("TYLOGO_COURRIER"),
  LOGO_CT: longtext("LOGO_CT"),
  FILIGRANNE: longtext("FILIGRANNE"),
  IMP_ENTETE: smallint("IMP_ENTETE"),
  IMP_BASPAGE: smallint("IMP_BASPAGE"),
  IMP_BASPAGECOURR: smallint("IMP_BASPAGECOURR"),
  MRG_HAUT_PIECE: tinyint("MRG_HAUT_PIECE"),
  MRG_BAS_PIECE: tinyint("MRG_BAS_PIECE"),
  ENTETE_COTE_COLRAISON: smallint("ENTETE_COTE_COLRAISON"),
  ENTETE_COLG: longtext("ENTETE_COLG"),
  ENTETE_COLD: longtext("ENTETE_COLD"),
  ENTETE_CADRAGE_COLG: smallint("ENTETE_CADRAGE_COLG"),
  ENTETE_CADRAGE_COLD: smallint("ENTETE_CADRAGE_COLD"),
  POLICE_RAISON: varchar("POLICE_RAISON", { length: 20 }),
  POLICE_ENTETE: varchar("POLICE_ENTETE", { length: 20 }),
  POLICE_ADRESSE: varchar("POLICE_ADRESSE", { length: 20 }),
  POLICE_TETECOL: varchar("POLICE_TETECOL", { length: 20 }),
  POLICE_CORPS: varchar("POLICE_CORPS", { length: 20 }),
  POLICE_TAILLE_RAISON: smallint("POLICE_TAILLE_RAISON"),
  POLICE_TAILLE_ENTETE: smallint("POLICE_TAILLE_ENTETE"),
  POLICE_TAILLE_ADRESSE: smallint("POLICE_TAILLE_ADRESSE"),
  POLICE_TAILLE_TETECOL: smallint("POLICE_TAILLE_TETECOL"),
  POLICE_TAILLE_CORPS: smallint("POLICE_TAILLE_CORPS"),
  LIB_BAS_IDENTITE: varchar("LIB_BAS_IDENTITE", { length: 320 }),
  LIB_BAS_FACTURE: longtext("LIB_BAS_FACTURE"),
  LIB_BAS_DEVIS: longtext("LIB_BAS_DEVIS"),
  LIB_BAS_COMMANDE: longtext("LIB_BAS_COMMANDE"),
  LIB_BAS_BLIVR: longtext("LIB_BAS_BLIVR"),
  LIB_BAS_FACTFOU: longtext("LIB_BAS_FACTFOU"),
  LIB_BAS_COMMFOU: longtext("LIB_BAS_COMMFOU"),
  LIB_BAS_ETAT: varchar("LIB_BAS_ETAT", { length: 320 }),
  CL_FACT: int("CL_FACT"),
  CL_DEVIS: int("CL_DEVIS"),
  CL_CDE: int("CL_CDE"),
  CL_BLIVR: int("CL_BLIVR"),
  CL_COMMFOU: int("CL_COMMFOU"),
  CL_FACTFOU: int("CL_FACTFOU"),
  CL_PREF: int("CL_PREF"),
  CL_FONDCOL: int("CL_FONDCOL"),
  CL_FONDCOL2: int("CL_FONDCOL2"),
  IMEME_COULEUR: tinyint("IMEME_COULEUR"),
  IDDELPMT_CLT: int("IDDELPMT_CLT"),
  DELAI_VALID_DEVIS: smallint("DELAI_VALID_DEVIS"),
  IDDELPMT_FRN: int("IDDELPMT_FRN"),
  IGERE_CMDE_DETAIL: tinyint("IGERE_CMDE_DETAIL"),
  CD_LANG: smallint("CD_LANG"),
  TYP_NUM_PIECE: smallint("TYP_NUM_PIECE"),
  PREFIX_PIECE: varchar("PREFIX_PIECE", { length: 3 }),
  PREFIX_USER: smallint("PREFIX_USER"),
  IMP_PAIEMENTS: smallint("IMP_PAIEMENTS"),
  IARRONDI_SUISSE: tinyint("IARRONDI_SUISSE"),
  ITOT_LETTRE: tinyint("ITOT_LETTRE"),
  UM_NOM: varchar("UM_NOM", { length: 12 }),
  UM_CENTIMES: varchar("UM_CENTIMES", { length: 12 }),
  IMP_RECTOVERSO: tinyint("IMP_RECTOVERSO"),
  IMP_CGV: tinyint("IMP_CGV"),
  IGERE_LOT: tinyint("IGERE_LOT"),
  IGERE_FACT_LIB: tinyint("IGERE_FACT_LIB"),
  IGERE_FACT_NUM: tinyint("IGERE_FACT_NUM"),
  IGERE_FACT_DT: tinyint("IGERE_FACT_DT"),
  IGERE_TIMBRE: tinyint("IGERE_TIMBRE"),
  MTT_TIMBRE_DEF: decimal("MTT_TIMBRE_DEF", { precision: 10, scale: 2 }),
  IPU_VARIABLES: tinyint("IPU_VARIABLES"),
  ILIEN_PAIEMENT: tinyint("ILIEN_PAIEMENT"),
  IMP_COORD_CTCLI: tinyint("IMP_COORD_CTCLI"),
  IMP_COORD_CTFOU: tinyint("IMP_COORD_CTFOU"),
  IMP_COORD_CTBL: tinyint("IMP_COORD_CTBL"),
  IMP_PIECE_TXCHANGE: tinyint("IMP_PIECE_TXCHANGE"),
  IMP_PIECE_ATTENTION: smallint("IMP_PIECE_ATTENTION"),
  IMP_PIECE_SANSTVA: tinyint("IMP_PIECE_SANSTVA"),
  IMP_PIECE_SANSQTE: tinyint("IMP_PIECE_SANSQTE"),
  IMP_PIECE_CARMACH: smallint("IMP_PIECE_CARMACH"),
  IMP_DEVIS_HT: tinyint("IMP_DEVIS_HT"),
  LIBOPTION_DEVIS: varchar("LIBOPTION_DEVIS", { length: 10 }),
  IMP_DEVIS_SANS_PRIX: tinyint("IMP_DEVIS_SANS_PRIX"),
  IMP_DEVIS_SANS_ACCORD: smallint("IMP_DEVIS_SANS_ACCORD"),
  IMP_DEVIS_SANS_CDTSRGLT: tinyint("IMP_DEVIS_SANS_CDTSRGLT"),
  IMP_BL_AVEC_PRIX: tinyint("IMP_BL_AVEC_PRIX"),
  IMP_BL_AVECSIG: smallint("IMP_BL_AVECSIG"),
  IMP_BL_POIDS: tinyint("IMP_BL_POIDS"),
  IENC_SEPARE: tinyint("IENC_SEPARE"),
  IDELAI_LIVR_AUTO: tinyint("IDELAI_LIVR_AUTO"),
  IMP_CDFOU_SLTQTE: tinyint("IMP_CDFOU_SLTQTE"),
  IMP_DEMPRIX_PRIX: tinyint("IMP_DEMPRIX_PRIX"),
  IMP_DEMPRIX_DELAI: tinyint("IMP_DEMPRIX_DELAI"),
  TYPE_PAPILLON_PIECE: smallint("TYPE_PAPILLON_PIECE"),
  IMP_CARMACH_INTER: smallint("IMP_CARMACH_INTER"),
  IECR_DATEDEF: tinyint("IECR_DATEDEF"),
  IGERE_CDBUDGET: tinyint("IGERE_CDBUDGET"),
  NBDEC_PXPROD: tinyint("NBDEC_PXPROD"),
  NBDEC_QTEPROD: tinyint("NBDEC_QTEPROD"),
  ICATALOGUE: tinyint("ICATALOGUE"),
  AFF_ONGLET_PRODUIT: tinyint("AFF_ONGLET_PRODUIT"),
  IGERE_PRODMOD: tinyint("IGERE_PRODMOD"),
  IGERE_PRODCOMP: tinyint("IGERE_PRODCOMP"),
  IGERE_SSFAM: tinyint("IGERE_SSFAM"),
  IGERE_REMISECHQ: tinyint("IGERE_REMISECHQ"),
  IGERE_DEEE: tinyint("IGERE_DEEE"),
  IGERE_RAYONS: tinyint("IGERE_RAYONS"),
  IGERE_TARIF_FOU: tinyint("IGERE_TARIF_FOU"),
  IGERE_TARIF_MULTI: tinyint("IGERE_TARIF_MULTI"),
  MODE_CONNECT: smallint("MODE_CONNECT"),
  TY_GESTHORAIRE: smallint("TY_GESTHORAIRE"),
  NBH_JOURHOMME: time("NBH_JOURHOMME"),
  CTRL_MAJ_ACT: smallint("CTRL_MAJ_ACT"),
  IGERE_STOCK_SIMPLE: tinyint("IGERE_STOCK_SIMPLE"),
  IGERE_STOCKS: tinyint("IGERE_STOCKS"),
  IGERE_EMPLSTOCK: tinyint("IGERE_EMPLSTOCK"),
  IGERE_NIVEAUXEMPL: tinyint("IGERE_NIVEAUXEMPL"),
  TYSUP_STOCK: smallint("TYSUP_STOCK"),
  TY_STOCKOUT: smallint("TY_STOCKOUT"),
  TY_STOCKIN: smallint("TY_STOCKIN"),
  CD_DEVISE: varchar("CD_DEVISE", { length: 3 }),
  NBDEC_ECRITURES: tinyint("NBDEC_ECRITURES"),
  SEP_DEC: varchar("SEP_DEC", { length: 1 }),
  SEP_MIL: varchar("SEP_MIL", { length: 1 }),
  IGERE_MACHINES: tinyint("IGERE_MACHINES"),
  LIB_MACHINE_RESS: varchar("LIB_MACHINE_RESS", { length: 25 }),
  LIB_MACHINE_LOC: varchar("LIB_MACHINE_LOC", { length: 25 }),
  LIB_MACHINE_MNT: varchar("LIB_MACHINE_MNT", { length: 25 }),
  IMACH_VEHIC: tinyint("IMACH_VEHIC"),
  IGERE_HEURELOC: tinyint("IGERE_HEURELOC"),
  COUL_ACTION_AGENDA: int("COUL_ACTION_AGENDA"),
  IGERE_POOLS: tinyint("IGERE_POOLS"),
  TYGEST_ADH: smallint("TYGEST_ADH"),
  DURDEF_ADH: smallint("DURDEF_ADH"),
  TXTVA_ADH: float("TXTVA_ADH"),
  LIB_ADH_PARAM: varchar("LIB_ADH_PARAM", { length: 20 }),
  LIB_CBOADH: varchar("LIB_CBOADH", { length: 20 }),
  ICTMEMBRE: tinyint("ICTMEMBRE"),
  LIB_CBOVERSMT: varchar("LIB_CBOVERSMT", { length: 20 }),
  IGERE_INTER_INGRED: tinyint("IGERE_INTER_INGRED"),
  IMP_COORD_INTER: tinyint("IMP_COORD_INTER"),
  TYPE_PAPILLON_INTER: smallint("TYPE_PAPILLON_INTER"),
  LIB_ADMIN: varchar("LIB_ADMIN", { length: 50 }),
  DHCRE: datetime("DHCRE"),
  USCRE: varchar("USCRE", { length: 3 }),
  DHMOD: datetime("DHMOD"),
  USMOD: varchar("USMOD", { length: 3 }),
...
export type ParamAppli = typeof paramappli.$inferSelect;
export type InsertParamAppli = typeof paramappli.$inferInsert;

// Schemas for form-related tables (forms, fields, values)
...
export const fields = mysqlTable("fields", {
  ...
  name: varchar("name", { length: 255 }).notNull(),
  type: mysqlEnum("type", ["text", "number", "date", "email", "password", "checkbox", "radio", "select", "textarea"]).notNull(),
